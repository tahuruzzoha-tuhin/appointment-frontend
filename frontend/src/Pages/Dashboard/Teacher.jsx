...
function Teacher() {
    ...
    try {
      ...
      if (jwtToken == null) {
        ...
        const response = await axios.get(
          ...
          }/api/teachers/getAllPendingStudents`,
          {
            headers: {
  ...
  const fetchTeacherData = async () => {
    try {
      ...
      const response = await axios.get(
        `${import.meta.env.VITE_BACKEND_URL}/api/teachers/schedule`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
  ...
  const handleDeleteAppointment = async (appointmentId) => {
    try {
      ...
      const response = await axios.delete(
        `${import.meta.env.VITE_BACKEND_URL
        }/api/teachers/reschedule/${appointmentId}`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
  ...
  const handleStudentApprove = async (studentId, teacherAppointmentId) => {
    try {
      ...
      const url = `${import.meta.env.VITE_BACKEND_URL
        }/api/teachers/changeApprovalStatus/${teacherAppointmentId}/${studentId}`;
